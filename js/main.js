...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const animateElements = document.querySelectorAll('.skill-card, .portfolio-card, .about-stats .stat');
    ...
    window.addEventListener('scroll', updateActiveNav);
      // Typing animation for hero title (disabled to preserve HTML structure)
    // Note: Typing animation commented out to preserve HTML formatting and gradient text
    ...
    // Update navbar scroll handler for dark mode
